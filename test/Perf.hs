...
import Crypto.JWT (CompactJWS, HasX5c (x5c), JWSHeader, JWTError, ProtectedOnly, decodeCompact, fromX509Certificate, param, verifyJWS')
...
instance VerificationKeyStore (ExceptT JWTError IO) (JWSHeader ProtectedOnly) B.ByteString Store where
