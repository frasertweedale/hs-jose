...
verifyJWT
  ::
    ...
    , VerificationKeyStore m (h ProtectedOnly) payload k
...
verifyClaims
  ::
    ...
    , HasJWSHeader h, HasParams h
    , AsError e, AsJWTError e, MonadError e m
    , VerificationKeyStore m (h ProtectedOnly) ClaimsSet k
    )
  => a
  -- ^ Validation settings
  -> k
...
verifyJWTAt
  ::
    ...
    , HasJWSHeader h, HasParams h
    , AsError e, AsJWTError e, MonadError e m
    , VerificationKeyStore (ReaderT WrappedUTCTime m) (h ProtectedOnly) payload k
    , HasClaimsSet payload, FromJSON payload
    )
  => a
  -- ^ Validation settings
...
verifyClaimsAt
  ::
    ...
    , HasJWSHeader h, HasParams h
    , AsError e, AsJWTError e, MonadError e m
    , VerificationKeyStore (ReaderT WrappedUTCTime m) (h ProtectedOnly) ClaimsSet k
    )
  => a
  -- ^ Validation settings
  -> k
